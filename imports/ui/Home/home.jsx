      ...
      <div className="homeDiv">
        ...
        <div className="tab-content">
          <div id="connections" className="tab-pane fade in active">
            <h3>CONNECTIONS</h3>
            <p>Here you would see news from you connections.</p>
          </div>
          <div id="jam" className="tab-pane fade">
            <h3>WHO WANTS TO JAM?</h3>
            <p>Here you would see the people in your area that want to get together and jam.</p>
          </div>
          <div id="members" className="tab-pane fade">
            <h3>LOOKING FOR MEMBERS/COLLABORATORS</h3>
            <p>Here you would find people in your area who are looking for band members or collaborators to work with.</p>
          </div>
          <div id="sell" className="tab-pane fade">
            <h3>FOR SALE/RENT</h3>
            <p>Here you would see instruments for sale/rent and possibly studio time to rent.</p>
          </div>
        </div>
      </div>
    )
